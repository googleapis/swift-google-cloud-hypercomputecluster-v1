# Google Cloud Client Libraries for Swift - Cluster Director API
...
Add `swift-google-cloud-hypercomputecluster-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-hypercomputecluster-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudHypercomputeClusterV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudHypercomputeClusterV1 <target-name> --package swift-google-cloud-hypercomputecluster-v1
```
