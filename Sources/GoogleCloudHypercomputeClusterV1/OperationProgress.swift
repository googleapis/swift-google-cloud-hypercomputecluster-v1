  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = OperationProgress().with { $0.steps = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([OperationStep].self, forKey: .steps) {
      self.steps = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.hypercomputecluster.v1.OperationProgress"
  }
