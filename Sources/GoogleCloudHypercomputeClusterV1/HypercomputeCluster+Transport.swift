...
extension Clients {
  final class HypercomputeClusterTransport: HypercomputeClusterStub {
    let inner: GoogleCloudGax._HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax._HTTPClient(
        from: options,
        withDefaultEndpoint: "https://hypercomputecluster.googleapis.com",
      )
    }
    ...
    public func listClusters(
      ...
      return try await req.rpc(
        GoogleCloudHypercomputeClusterV1.ListClustersResponse.self, timeout: options.attemptTimeout
      ).get()
    }
    ...
    public func getCluster(
      ...
      req.addHeader(name: GoogleCloudGax._HeaderNames.apiClient, value: Clients.clientHeader)
      return try await req.rpc(
        GoogleCloudHypercomputeClusterV1.Cluster.self, timeout: options.attemptTimeout
      ).get()
    }
