...
public struct UpdatePartition: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdatePartition`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdatePartition().with { $0.partitions = ... }
  /// ```
