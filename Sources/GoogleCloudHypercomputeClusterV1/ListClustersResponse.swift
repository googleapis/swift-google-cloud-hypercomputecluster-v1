  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let clusters = CodingKeys(stringValue: "clusters")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Cluster].self, forKey: .clusters) {
      self.clusters = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.clusters, forKey: .clusters)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.hypercomputecluster.v1.ListClustersResponse"
  }
