...
///
/// [google.cloud.hypercomputecluster.v1.HypercomputeCluster.DeleteCluster]: <doc:HypercomputeClusterClient/deleteCluster(request:options:)>
  ...
  Sendable
{
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.hypercomputecluster.v1.DeleteClusterRequest"
  }
