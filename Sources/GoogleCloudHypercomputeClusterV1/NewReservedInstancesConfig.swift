...
public struct NewReservedInstancesConfig: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = NewReservedInstancesConfig().with { $0.reservation = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let reservation = try container.decodeIfPresent(Swift.String.self, forKey: .reservation) {
