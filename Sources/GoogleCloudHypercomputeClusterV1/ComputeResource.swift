...
public struct ComputeResource: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Required. Immutable. Configuration for this compute resource, which
  /// describes how it should be created at runtime.
  public var config: ComputeResourceConfig? = nil
  ...
  ///
  /// ```
  /// let value = ComputeResource().with { $0.config = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.config = try container.decodeIfPresent(ComputeResourceConfig.self, forKey: .config)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.hypercomputecluster.v1.ComputeResource"
  }
